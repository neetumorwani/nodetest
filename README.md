...
Hello and welcome to the X-Team Exam. The following is a small programming task to get you started. Follow the instructions below to get your solution, and paste it back into the form where you registered.

Prerequisites
----

You'll need to install [nodejs](https://nodejs.org/en/) to complete the exam.
...
The program in this exam is a very simple messaging system. There is a database of messages, and users can read their messages one at a time.
